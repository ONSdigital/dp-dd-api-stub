...
sed dp-dd-api-stub/appspec.yml dp-dd-api-stub/scripts/codedeploy/* -i \
...
cp dp-dd-api-stub/appspec.yml artifacts/
cp dp-dd-api-stub/scripts/codedeploy/* artifacts/scripts/codedeploy
